  ...
  const timeline = [
    {
      ...
      description: `The Apple Macintosh—later rebranded as the Macintosh 128K—is the original Apple Macintosh personal computer.
			<ul class="list-disc list-outside marker:text-black my-0">
      	<li class="my-0">It played a pivotal role in establishing desktop publishing as a general office function.</li>
       	<li class="my-0">The motherboard, a 9 in (23 cm) CRT monitor, and a floppy drive were housed in a beige case with integrated carrying handle; it came with a keyboard and single-button mouse.</li>
			</ul>`,
    },
    {
      date: "1998",
  ...
  return (
    <div className="">
      {/* <div className="flex flex-row gap-2">
        ...
        <div className="text-xl font-medium uppercase">Education</div>
      </div> */}

      <div className="text-md font-medium uppercase mb-0 pb-0">Education</div>
      
      <hr className="border-black rounded-sm mb-2 mt-0" />
