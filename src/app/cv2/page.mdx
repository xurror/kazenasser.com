...
<p>
  <a href="https://tailwindcss.com/docs/typography-plugin" target="_blank">
    <picture>
      ...
      <img alt="Tailwind CSS Typography" src="https://raw.githubusercontent.com/tailwindlabs/tailwindcss-typography/HEAD/.github/logo-light.svg" width="450" height="70" />
    </picture>
  </a>
</p>
...
<ul className="timeline timeline-snap-icon timeline-vertical cv-timeline">
  <li>
    ...
    <div className="timeline-end cv-text-block mt-4">
      <div className="text-lg font-black">First Macintosh computer</div>
      <div>
        The Apple Macintosh—later rebranded as the Macintosh 128K—is the original Apple Macintosh
        personal computer.
        - It played a pivotal role in establishing desktop publishing as a general
        office function.
        - The motherboard, a 9 in (23 cm) CRT monitor, and a floppy drive were housed
  ...
  <li>
    ...
    <div className="timeline-start pt-1">
